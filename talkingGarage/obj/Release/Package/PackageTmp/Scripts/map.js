...
function showPosition(position) {
    ...
    while(i < geojson.features.length){
        ...
        if(dis < 1.5){
            places = places + "<div class='places'><h3>"
                     + geojson.features[i].properties.title + "</h3><p>"
                     + dis.toFixed(2) + " km &bull; " + geojson.features[i].properties.description
                     + " &bull; <a style='color:white;' href='../hold/" + geojson.features[i].properties.id + "'>Hold space</a></p></div><hr style='border: 0.5px solid grey;' />";
        }  
        i++;
    }
